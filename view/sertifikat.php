...
<div class="app-layout">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="sertifikat.php?nama=<?= urlencode($nama_user); ?>&role=<?= urlencode($role_user); ?>" class="nav-item active"><span class="nav-icon">🎓</span> Sertifikat</a>
            <div class="nav-label">Akun</div>
            <a href="profil.php?nama=<?= urlencode($nama_user); ?>&role=<?= urlencode($role_user); ?>" class="nav-item"><span class="nav-icon">👤</span> Profil Saya</a>
        ...
        <div class="page-content">
            ...
            <?php else: ?>
                <div class="cert-main-box locked-container">
                    ...
                    <a href="profil.php?nama=<?= urlencode($nama_user); ?>&role=<?= urlencode($role_user); ?>" class="btn-upgrade">Upgrade ke Premium Sekarang</a>
                </div>
            <?php endif; ?>
