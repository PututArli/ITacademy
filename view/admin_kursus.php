...
<head>
    ...
    <style>
        ...
        /* Diselaraskan agar display kaku bawaan tidak memblokir animasi popup kustom */
...
<div class="app-layout">
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?= BASEURL ?>/index.php?page=admin_kursus" class="nav-item active"><span class="nav-icon">&#9650;</span> Kursus</a>
